...
papaya.viewer.Viewer.prototype.drawViewer = function (force, skipUpdate) {
    ...
    if (skipUpdate) {
        ...
        //this.mipSlice.repaint(this.currentCoord.x, force, this.worldSpace);
    } else {
        ...
        if (force || (this.draggingSliceDir !== papaya.viewer.ScreenSlice.DIRECTION_SAGITTAL)) {
            ...
            //this.mipSlice.updateSlice(this.currentCoord.z, force, this.worldSpace);
        }
        //console.log(this.mipSlice.updateMipSlice("",""));
        //papaya.viewer.ScreenSlice.prototype.updateMipSlice("","");
...
papaya.viewer.Viewer.prototype.isListingStudies = function () {
    return (this.container.preferences.showRuler === "Yes");
};
