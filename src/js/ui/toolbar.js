...
papaya.ui.Toolbar.COS_MENU_DATA = {"label": "Dropbox", "icons": null,
    "items": [
    {"label": "Dir path", "action": "OpenDropboxFolder", "type": "cloud", "method":"isListingStudies"}
        //TODO: extend and refactor
]};

papaya.ui.Toolbar.MENU_DATA = {
    "menus": [
        papaya.ui.Toolbar.FILE_MENU_DATA,
        papaya.ui.Toolbar.COS_MENU_DATA,
...
papaya.ui.Toolbar.prototype.buildMenuItems = function (menu, itemData, topLevelButtonId, dataSource, modifier) {
    ...
    for (ctrItems = 0; ctrItems < itemData.length; ctrItems += 1) {
        if (!itemData[ctrItems].required || ((papaya.utilities.ObjectUtils.bind(this.container,
            ...
            } else if (itemData[ctrItems].type === "inputField") {
                item = new papaya.ui.MenuItemInputField(this.viewer, itemData[ctrItems].label, itemData[ctrItems].action,
            ...
            }else if (itemData[ctrItems].type === "cloud") {
                if (!itemData[ctrItems].hide) {
                    item = new papaya.ui.MenuItemInputField(this.viewer, itemData[ctrItems].label,
                        itemData[ctrItems].action, papaya.utilities.ObjectUtils.bind(this, this.doAction), false);
                }
...
papaya.ui.Toolbar.prototype.doAction = function (action, file, keepopen) {
    ...
    if (action) {
        if (action.startsWith("ImageButton")) {
            ...
            papaya.ui.Toolbar.VIEWER = this.viewer;
            ...
            this.viewer.loadImage(file);
            papaya.ui.Toolbar.VIEWER = this.viewer;
        } else if(action == "OpenDropboxFolder") {
            //papaya.container.display.drawProgress(0.1, "Loading");
            papaya.ui.Toolbar.VIEWER.loadImage(file);
            ...
            //Clearing the 3D canvases
            var c = document.getElementById("myCanvas3");
            var context = c.getContext("2d");
            context.clearRect(0, 0, c.width, c.height);

            //Unbind evenet listeners
            var new_element = c.cloneNode(true);
            ...
            //Unbind evenet listeners
            var new_element2 = c2.cloneNode(true);
            c2.parentNode.replaceChild(new_element2, c2);

            //Clear volume buffer
            volBuffer = Module._free;
...
papaya.ui.Toolbar.prototype.mipMode = function () {
    var mipCanvas = document.getElementById("myCanvas2");
    mipCanvas.style.display = "inline";
    var minipCanvas = document.getElementById("myCanvas4");
    minipCanvas.style.display = "none";
    var vrCanvas = document.getElementById("myCanvas3");
    vrCanvas.style.display = "none";
    var mipButton = document.getElementById("mipButton");
    mipButton.style.color = "red";
    var minipButton = document.getElementById("minipButton");
    minipButton.style.color = "black";
    var vrButton = document.getElementById("vrButton");
    vrButton.style.color = "black";
};

papaya.ui.Toolbar.prototype.minipMode = function () {
    var minipCanvas = document.getElementById("myCanvas4");
    minipCanvas.style.display = "inline";
    var vrCanvas = document.getElementById("myCanvas3");
    vrCanvas.style.display = "none";
    var mipCanvas = document.getElementById("myCanvas2");
    mipCanvas.style.display = "none";
    var minipButton = document.getElementById("minipButton");
    minipButton.style.color = "red";
    var mipButton = document.getElementById("mipButton");
...
papaya.ui.Toolbar.prototype.vrMode = function () {
    var vrCanvas = document.getElementById("myCanvas3");
    vrCanvas.style.display = "inline";
    var minipCanvas = document.getElementById("myCanvas4");
    minipCanvas.style.display = "none";
    var mipCanvas = document.getElementById("myCanvas2");
    mipCanvas.style.display = "none";
    var vrButton = document.getElementById("vrButton");
    vrButton.style.color = "red";
    var minipButton = document.getElementById("minipButton");
    minipButton.style.color = "black";
    var mipButton = document.getElementById("mipButton");
    mipButton.style.color = "black";
